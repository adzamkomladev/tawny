...
<template>
  <section id="pricing" class="py-24 sm:py-32 bg-muted/20 overflow-hidden">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="max-w-4xl mx-auto mb-20">
        <div class="relative animate-on-scroll" style="animation-delay: 150ms">
          ...
          <!-- Card -->
          <div
            class="relative bg-white dark:bg-background border-2 border-primary/20 rounded-2xl overflow-hidden shadow-xl">
            <!-- Top Accent -->
            ...
            <div class="p-8 sm:p-12">
              <div class="grid lg:grid-cols-2 gap-10 items-center">
                ...
                <div class="text-center lg:text-left">
                  <div
                    class="inline-flex items-center gap-2 bg-primary/10 text-black text-sm font-medium px-4 py-2 rounded-full mb-6">
                ...
                <!-- Right: Features List -->
                <div class="bg-muted/30 rounded-xl p-6 sm:p-8">
      ...
      <div class="max-w-4xl mx-auto">
        <div class="grid sm:grid-cols-3 gap-6 sm:gap-8">
          <div v-for="(highlight, index) in highlights" :key="highlight.title"
            class="text-center group animate-on-scroll" :style="{ animationDelay: `${300 + index * 100}ms` }">
            <div
