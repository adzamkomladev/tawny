...
<template>
    <Card class="border-border/50 sticky top-24">
        ...
        <CardContent class="space-y-4">
            ...
            <!-- Map Button -->
            <Button v-if="mapUrl" variant="outline" class="w-full gap-2" as-child>
            ...
            <div class="space-y-3">
                ...
                <div class="grid grid-cols-3 gap-2">
                    <button
                        class="flex flex-col items-center gap-1.5 p-3 rounded-xl bg-muted/50 hover:bg-muted transition-colors group">
                        <div
                            class="size-9 rounded-full bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                            <Icon name="lucide:calendar-plus" class="size-4 text-primary" />
                        </div>
                    ...
                    <button
                        ...
                        <span class="text-xs font-medium">Remind</span>
                    </button>
                    <button
                        class="flex flex-col items-center gap-1.5 p-3 rounded-xl bg-muted/50 hover:bg-muted transition-colors group">
                        <div
                            class="size-9 rounded-full bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                            <Icon name="lucide:share-2" class="size-4 text-primary" />
                        </div>
                        <span class="text-xs font-medium">Share</span>
                    </button>
                </div>
                <button
                    class="text-xs text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1 mx-auto">
